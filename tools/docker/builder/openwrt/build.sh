...
PRPL_FEED='https://git.prpl.dev/prplmesh/feed-prpl.git^531c27d86a912a12d649320418817db281534eb0'
# TODO: update all the hashed to use the stable branch once built!
INTEL_FEED=""
IWLWAV_FEED=""
