...
public:
    ...
    virtual bool scan_lock(const std::string& monitor_iface) override;
    virtual bool scan_unlock(const std::string& monitor_iface) override;
    virtual bool is_scan_lock_owner(const std::string& monitor_iface) override;
    // Protected methods:
protected:
