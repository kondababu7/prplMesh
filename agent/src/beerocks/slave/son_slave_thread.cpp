                                                  ...
                                                  std::shared_ptr<beerocks_header> beerocks_header)
{
    ...
    case beerocks_message::ACTION_APMANAGER_JOINED_NOTIFICATION: {
        ...
        auto supported_channels_ptr = &std::get<1>(notification->supported_channels_list(0));
        supported_channels.insert(supported_channels.end(), supported_channels_ptr,
                                  supported_channels_ptr + message::RADIO_CHANNELS_LENGTH);
